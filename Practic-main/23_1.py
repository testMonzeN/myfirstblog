...
class multifilter():
    ...
    def __iter__(self):
        # план как это делать
        # перебираем последовательность
        # обновить pos и neg
        # перебираем функции
        # если наша функция(mul2 или mul3 или mul5) от числа i получится True
        # то мы увеличим кол-во поз исходов
        # кол-во негативов можно найти отняв от кол-ва всех функций кол-во позитивных исходов
        # дальше от решающей функции в self.judge зависит исход добавления в последовательность
